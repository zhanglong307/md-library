...
import com.allin.mdlibrary.util.MdDisplayUtil;


public class MdViewPrinterProvider {
    ...
    public MdViewPrinterProvider(FrameLayout rootView, RecyclerView recyclerView) {
    ...
    public void showFloatingView() {
        ...
        params.bottomMargin = MdDisplayUtil.dp2px(100, rootView.getResources());
    ...
    public void showLogView() {
        ...
        FrameLayout.LayoutParams params =
            new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, MdDisplayUtil.dp2px(160, rootView.getResources()));
