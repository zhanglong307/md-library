 ...
 */
public class MdFilePrinter implements MdLogPrinter {
    private static final ExecutorService EXECUTOR = Executors.newSingleThreadExecutor();
    private final String logPath;
    private final long retentionTime;
    private LogWriter writer;
    private volatile PrintWorker worker;
    private static MdFilePrinter instance;
     ...
     */
    public static synchronized MdFilePrinter getInstance(String logPath, long retentionTime) {
        if (instance == null) {
            instance = new MdFilePrinter(logPath, retentionTime);
        }
        return instance;
    }


    private MdFilePrinter(String logPath, long retentionTime) {
    ...
    public void print(@NonNull MdLogConfig config, int level, String tag, @NonNull String printString) {
        ...
        worker.put(new MdLogMo(timeMillis, level, tag, printString));
    }

    private void doPrint(MdLogMo logMo) {
    ...
    private class PrintWorker implements Runnable {
        ...
        private BlockingQueue<MdLogMo> logs = new LinkedBlockingQueue<>();
